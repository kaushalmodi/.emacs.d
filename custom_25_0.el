...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (require gh logito pcache helm transpose-frame unfill zop-to-char yasnippet yaml-mode yafolding xkcd wrap-region wgrep-ag web-mode volatile-highlights visual-regexp undo-tree tiny sx sunshine stripe-buffer smex smart-mode-line smart-compile use-package region-bindings-mode rectangle-utils rainbow-mode rainbow-delimiters python-mode poporg pdf-tools paradox page-break-lines ox-reveal outshine number nlinum neotree navi-mode mwe-log-commands multiple-cursors marshal manage-minor-mode magit linum-relative leuven-theme key-chord iy-go-to-char isend-mode iregister indent-guide ido-vertical-mode ido-ubiquitous ibuffer-projectile hydra hungry-delete htmlize hl-line+ hl-anything help-fns+ helm-swoop header2 hardcore-mode guide-key gist ggtags fuzzy flx-ido fill-column-indicator f expand-region eww-lnum epresent elisp-slime-nav elfeed eimp drag-stuff discover-my-major dired-single dired+ csv-nav buffer-move bookmark+ benchmark-init auto-highlight-symbol auto-complete anzu ag ace-window)))
