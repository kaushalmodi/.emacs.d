...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (ascii-art-to-unicode bm all all-ext help-fns+ org-trello engine-mode tao-theme list-environment imenu-list git-timemachine easy-escape hl-anything writegood-mode hideshow-org hideshowvis deft counsel interleave git-link shackle google-contacts minibuffer-line zop-to-char yasnippet yaml-mode yafolding xkcd wrap-region wgrep-ag web-mode volatile-highlights visual-regexp use-package undo-tree twilight-bright-theme twilight-anti-bright-theme tiny sx swiper sunshine stripe-buffer smex smart-mode-line smart-compile rpn-calc region-bindings-mode rectangle-utils rainbow-mode rainbow-delimiters planet-theme paradox page-break-lines ox-reveal outshine org-tree-slide org-plus-contrib number nlinum neotree navi-mode mwe-log-commands multiple-cursors multi-term manage-minor-mode magit linum-relative leuven-theme kurecolor keyfreq key-chord iy-go-to-char isend-mode iregister indent-guide ido-vertical-mode ido-ubiquitous ibuffer-projectile hydra hungry-delete htmlize hl-line+ helm-swoop helm-gtags header2 hardcore-mode guide-key gplusify gist ggtags fuzzy fold-this flx-ido fill-column-indicator expand-region eww-lnum etags-table etags-select elisp-slime-nav elfeed eimp drag-stuff discover-my-major dired-single dired+ diff-hl darktooth-theme ctags-update csv-nav buffer-move bookmark+ benchmark-init auto-highlight-symbol auto-complete anzu ample-theme aggressive-indent ag adaptive-wrap ace-window ace-jump-mode)))
