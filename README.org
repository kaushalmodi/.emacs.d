...
#+begin_quote
My emacs setup requires emacs 30.1 or newer. All of the version
compatibility shims for older releases have been removed, so it will
*not* work on emacs 29 and older. If you are on an older version, I
would recommend that you upgrade to the [[https://www.gnu.org/software/emacs/download.html][latest available stable
version]].
