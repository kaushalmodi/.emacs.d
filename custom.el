...
(custom-set-variables
 ...
 '(custom-theme-load-path (quote ("/home/kmodi/.emacs.d/elpa/leuven-theme-20140917.40/" "/home/kmodi/.emacs.d/elpa/smart-mode-line-20140904.1144/" "~/.emacs.d/from-git/zenburn-emacs/" custom-theme-directory t)))
 ...
 '(safe-local-variable-values (quote ((eval local-set-key (kbd "<s-f10>") (quote modi/org-export-to-html-txt-pdf)) (eval local-set-key (kbd "<C-f10>") (quote dv-docs-dis)) (eval local-set-key (kbd "<S-f10>") (quote dv-docs-ci)) (eval local-set-key (kbd "<f10>") (quote dv-docs-co)) (eval local-set-key "<C-f10>" (quote dv-docs-dis)) (eval local-set-key "<S-f10>" (quote dv-docs-ci)) (eval local-set-key "<f10>" (quote dv-docs-co)) (org-export-allow-bind-keywords . t) (org-confirm-babel-evaluate) (lisp-backquote-indentation . t) (eval when (require (quote rainbow-mode) nil t) (rainbow-mode 1)) (py-indent-offset . 4) (header-auto-update-enabled))))
